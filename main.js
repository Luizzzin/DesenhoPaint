...
largura.textContent = larguraPincel
...
canvas.addEventListener("mousedown", function (event) {
    ...
    contexto.larguraPincel = brushWidth;
...
canvas.addEventListener("mouseup", function (event) {
    // essa funçao identifica quando nao estamos mais clicando no mouse
    desenhando = false
})
...
document.getElementById('colores').addEventListener('change', function () {
    contexto.strokeStyle = document.getElementById('colores').value;
});